...
const patientSchema = z.object({
    ...
    geboortedatum: z.string().transform((value) => new Date(value)).refine((date) => !isNaN(date.getTime()), INVALID_DATE_MESSAGE),
...
export function EditPatientDialog({ isOpen, patientData, onSubmit, onClose }: EditPatientDialogProps) {
    ...
    return (
        <Dialog open={isOpen} onClose={onClose}>
            <form onSubmit={handleSubmit(onSubmitHandler)} noValidate>
                ...
                <DialogContent>
                    <DialogContentText>Update the patient details below</DialogContentText>
                            ...
                            <Controller
                                ...
                                render={({ field: controllerField }) => (
                                    <TextField
                                        ...
                                        value={controllerField.value || ''} // Ensures existing data is shown
